<?php
trait ModalTrait {
    public function Confirma($msg, $pagina) {
        echo '
        ...
        echo '
            <div class="grid h-screen place-content-center bg-white px-4" id="myModal">
                <div class="text-center">
                    ...
                    <button class="mt-6 inline-block rounded bg-indigo-600 px-5 py-3 text-sm font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring" onclick="redirecionar()">Voltar</button>
                </div>
            </div>
            <script>
                function redirecionar(){
    ...
    public function DML($sql, $confirma, $erro, $pagina)
    {
